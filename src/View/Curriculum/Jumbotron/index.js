...
const Jumbotron = () => {
  const scrollPosition = document.getElementById('courseContainerPosition')
    ? document.getElementById('courseContainerPosition').offsetTop - 50
    : 0
  ...
  return (
    <Container>
      <div className="col--1">
        ...
        <Button onClick={() => scrollTo(null, scrollPosition)}>
          Go to Courses
        </Button>
      </div>
      <div className="col--2">
