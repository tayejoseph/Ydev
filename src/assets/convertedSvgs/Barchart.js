...
function SvgBarchart(props) {
  return (
    <svg
      ...
      {...props}
    >
      <path fill="url(#Barchart_svg__pattern0)" d="M0 0h56v69.736H0z" />
      <defs>
        <pattern
          id="Barchart_svg__pattern0"
          patternContentUnits="objectBoundingBox"
          width={1}
          height={1}
        >
          <use
            xlinkHref="#Barchart_svg__image0_2228:2053"
            transform="scale(.01887 .01515)"
          />
        </pattern>
        <image
          id="Barchart_svg__image0_2228:2053"
          width={53}
          height={66}
