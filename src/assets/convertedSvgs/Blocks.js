...
function SvgBlocks(props) {
  return (
    <svg
      ...
      {...props}
    >
      <path fill="url(#Blocks_svg__pattern0)" d="M.364 0h40.913v50.948H.364z" />
      <defs>
        <pattern
          id="Blocks_svg__pattern0"
          patternContentUnits="objectBoundingBox"
          width={1}
          height={1}
        >
          <use
            xlinkHref="#Blocks_svg__image0"
            transform="scale(.01887 .01515)"
          />
        </pattern>
        <image
          id="Blocks_svg__image0"
          width={53}
          height={66}
